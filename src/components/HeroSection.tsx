      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            DVK AI plugs directly into Slack, WhatsApp, Teams, Instagram, and email—so you move from endless ticket hell to real relationships, faster than ever.
          </p>
        </div>
        ...
        <div className="max-w-md mx-auto mb-8">
          <div className="flex flex-col sm:flex-row gap-4">
            <Input 
              ...
              className="flex-1 bg-deep-charcoal border-gray-600 text-white placeholder-gray-400 focus:border-neon-teal focus:ring-neon-teal"
            />
            <Button className="btn-primary whitespace-nowrap">
              See DVK AI in Action
            </Button>
          </div>
          <p className="text-gray-500 text-sm mt-2 text-center">Free 14-day trial</p>
        </div>
          ...
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-2">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M5.042 15.165a2.528 2.528 0 0 0-2.52 2.523A2.528 2.528 0 0 0 5.042 20.21a2.528 2.528 0 0 0 2.52-2.522 2.528 2.528 0 0 0-2.52-2.523zm6.906 4.402c-.66 0-1.167-.435-1.167-1.06v-7.1c0-.625.507-1.06 1.167-1.06.66 0 1.166.435 1.166 1.06v7.1c0 .625-.507 1.06-1.166 1.06zm5.537 0c-.66 0-1.166-.435-1.166-1.06v-7.1c0-.625.507-1.06 1.166-1.06.66 0 1.167.435 1.167 1.06v7.1c0 .625-.507 1.06-1.167 1.06z"/>
              </svg>
              Slack
            </span>
            <span className="flex items-center gap-2">
